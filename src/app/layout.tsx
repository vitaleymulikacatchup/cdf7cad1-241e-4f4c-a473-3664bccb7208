...
export const metadata: Metadata = {
  title: "Grand Paradise Hotel - Luxury 5-Star Accommodation",
  description: "Experience luxury redefined at Grand Paradise Hotel. Premium suites, world-class amenities, fine dining, and exceptional service. Book your unforgettable stay today.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, fine dining, spa, business travel, romantic getaway",
  metadataBase: new URL("https://grandparadisehotel.com"),
  alternates: {
    canonical: "https://grandparadisehotel.com"
  },
  openGraph: {
    title: "Grand Paradise Hotel - Luxury 5-Star Accommodation",
    description: "Experience luxury redefined at Grand Paradise Hotel with premium suites, world-class amenities, and exceptional service.",
    siteName: "Grand Paradise Hotel",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/189295/pexels-photo-189295.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Grand Paradise Hotel luxury lobby"
    }]
  },
  twitter: {
